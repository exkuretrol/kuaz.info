...
% 邊界
\usepackage[hmargin=0.4cm,vmargin=0.4cm]{geometry}
%\usepackage{setspace}
...
% 工作經驗
\section{工作經驗}
\cventry{2024--持續中}{Django 全端工程師}{好物有限公司}{}{}{
\begin{itemize}
...
\cventry{2021--2022}{產業實習}{}{}{}{
\begin{itemize}
  \item \textbf{資料工程實習生，明台產物保險（2022.09--2022.10）}  
        使用 SQL 清理與處理客戶保單資料，提升數據分析效率。
  \item \textbf{專案實習，台灣郵政大數據準備室（2021.12）}  
        撰寫 SQL 語法，協助建立客戶清單。
\end{itemize}
}
...
% 平台建置與維運經驗
\section{平台建置與維運經驗}
\cventry{2025--持續中}{AI 平台維護}{}{}{}{管理銘傳大學應統系 aiWorks AI 訓練工作站，負責 Linux 系統維護、平台工作區容器建置，支援師生深度學習模型訓練。}

\cventry{2022--持續中}{網站伺服器建置}{}{}{}{建置並維護銘傳大學桃園行政處與統計系 WordPress 網站。}

\cventry{2024--持續中}{容器化與自動化}{}{}{}{使用 Docker、GitOps 與 Ansible 進行服務部署，搭配 Grafana/Prometheus 監控系統效能，提升維護效率與可靠性。}

% 技能
\section{技能}
\cvitem{系統自動化}{Linux (Ubuntu/Debian)、Ansible（初階）、CI/CD (GitHub Actions)}
\cvitem{虛擬化容器}{Proxmox、VM、LXC、Docker}
\cvitem{程式碼管理}{GitOps、Gitea、GitHub Actions}
\cvitem{監控與維運}{Grafana、Grafana Alloy、Prometheus}
\cvitem{程式語言}{Python、Shell Script、R、C/C++、\LaTeX}
\cvitem{Web 開發}{Django、HTML、CSS、JavaScript、Tailwind CSS}
...
%    技術經理 \\
%    好物有限公司 \\
%    \href{mailto:kleskowu@jefec.com}{kleskowu@jefec.com}%
%  }
%\end{cvcolumns}
